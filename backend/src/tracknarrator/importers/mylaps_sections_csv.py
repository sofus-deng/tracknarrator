...
class MYLAPSSectionsCSVImporter:
    ...
    SECTION_PATTERNS = {
        ...
        "FL": [
            r"\bFL\b",
            r"\bFL(_TIME|_ELAPSED|_SEC|_S|_MS)?\b",
    ...
    def _get_lap_number(cls, row: Dict[str, str]) -> str:
        ...
        for header in ['LAP_NUMBER', 'LAP', 'LAPNO', 'Lap', 'lap']:
